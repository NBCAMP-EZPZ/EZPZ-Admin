...
import com.sparta.ezpzadmin.common.security.dto.AuthenticatedResponse;
import com.sparta.ezpzadmin.common.security.dto.UnauthenticatedResponse;
        ...
        if (StringUtils.hasText(accessToken)) {
            ...
            if (tokenProvider.validateAccessToken(accessToken)) {
                ...
                if (tokenProvider.validateRefreshToken(refreshToken)) {
                    ...
                    String username = tokenProvider.getUsernameFromRefreshToken(refreshToken); // error
