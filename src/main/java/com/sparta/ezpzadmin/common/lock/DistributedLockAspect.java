package com.sparta.ezpzadmin.common.lock;

import com.sparta.ezpzadmin.common.util.CustomSpELParser;
...
public class DistributedLockAspect {
    ...
    @Around("@annotation(com.sparta.ezpzadmin.common.lock.DistributedLock)")
